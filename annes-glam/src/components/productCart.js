...
const ProductCart=(props) => {
  ...
  return (
    <div className='bg-gray-200 p-5 rounded-xl shadow-sm'>
       <Link to={slug}>
          <img src={image} alt='' className='w-full h-88 object-cover object-top object-top drop-shadow-[0_80px_30px_#0007]' />
       </Link>
       <h3 className='text-2xl py-3 text-center font-medium'>{name}</h3>
       <div className='flex justify-between items-center'>
       <p>
         R<span className='text-1xl font-medium'>{price}</span>        
       </p>
